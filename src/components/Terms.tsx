  ...
  return (
    <div className="min-h-screen bg-bg-base py-24 px-8 max-w-4xl mx-auto">
      ...
      <div className="prose prose-stone max-w-none text-mute-text space-y-6">
        <p>Estes Termos de Uso regem a utilização do programa Você Diva na Menopausa e dos serviços oferecidos por Fabiola Feliciano.</p>
        ...
        <p>O Você Diva na Menopausa é um programa de condicionamento físico online. Os resultados podem variar de pessoa para pessoa e dependem da dedicação, genética e estilo de vida de cada usuário.</p>
